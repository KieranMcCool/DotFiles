...
sudo pacman -S --noconfirm git neovim yay pandoc pandoc-citeproc texlive-core caprine kdeplasma-addons npm dotnet-sdk dotnet-runtime lutris latte-dock redshift tmux
